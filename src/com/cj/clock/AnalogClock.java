...
/*
        if (mDial == null) {
            mDial = r.getDrawable(R.drawable.wt_clock_dial);
        }
*/
        mHourHand = a.getDrawable(R.styleable.AnalogClock_hand_hour);
/*
        if (mHourHand == null) {
            mHourHand = r.getDrawable(R.drawable.wt_clock_hand_hour);
        }
*/
        mMinuteHand = a.getDrawable(R.styleable.AnalogClock_hand_minute);
/*
        if (mMinuteHand == null) {
            mMinuteHand = r.getDrawable(R.drawable.wt_clock_hand_minute);
        }
*/
...
*/
    ...
    private void onTimeChanged() {
        ...
        mDayOfMonth = mCalendar.monthDay;
	  ...
	  if(mWeek == 0){
        ...
        mChanged = true;
		android.util.Log.i("hcj","mWeek="+mWeek);
